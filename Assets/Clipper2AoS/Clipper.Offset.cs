...
namespace Clipper2AoS
{
    ...
    public struct ClipperOffsetL
    {
        ...
        internal static double2 GetUnitNormal(long2 pt1, long2 pt2)
        {
            ...
            if ((dx == 0) && (dy == 0)) return new double2();
        ...
        private static double2 NormalizeVector(double2 vec)
        {
            ...
            if (AlmostZero(h)) return new double2(0, 0);
        ...
        private static double2 IntersectPoint(double2 pt1a, double2 pt1b, double2 pt2a, double2 pt2b)
        {
            ...
            {
                if (InternalClipper.IsAlmostZero(pt2a.x - pt2b.x)) return new double2(0, 0);
            ...
            else
            {
                ...
                double m2 = (pt2b.y - pt2a.y) / (pt2b.x - pt2a.x);
                double b2 = pt2a.y - m2 * pt2a.x;
                if (InternalClipper.IsAlmostZero(m1 - m2)) return new double2(0, 0);
