...
{    
    public static class PolyTreeAccessorExtensions
    {
        ...
        public static void PolyTree_GetSolution_DepthFirst(this ref ClipperL clipperL, ref PolyTree polytree, ref NativeList<int2> solutionNodes, ref NativeList<int> solutionStartIDs)
        {
        ...
        public static void PolyTree_GetSolution_BreathFirst(this ref ClipperL clipperL, ref PolyTree polytree, ref NativeList<int2> solutionNodes, ref NativeList<int> solutionStartIDs)
        {
            var root = polytree.root;
            var nodes = polytree.nodes;
            if (root == -1) return;
        ...
        public static void PolyTree_WriteToFile_DepthFirst(this ref ClipperL clipperL, ref PolyTree polytree, ref NativeList<int2> solutionNodes, ref NativeList<int> solutionStartIDs)
        {
                ...
                if (nodeIndex != 0) //skip root node
                {
                    ...
                    switch (level)
                    {
                        ...
                        case 4:
                            ...
                            writer.WriteLine($"{parentParentParent.outrecIdx:D3}__{parentParent.outrecIdx:D3}__{parent.outrecIdx:D3}__{node.outrecIdx:D3} ({solutionNodes.Length - 1} nodes)");
                            break;
                        default:
        ...
        public static void PolyTree_WriteToFile_BreathFirst(this ref ClipperL clipperL, ref PolyTree polytree, ref NativeList<int2> solutionNodes, ref NativeList<int> solutionStartIDs)
        {
            StreamWriter writer = new StreamWriter("polytree_wrong.txt", false);
            TreeNode parent;
            TreeNode parentParent;
