...
namespace Polybool
{
    public static class Math128
    {
        ...
        public static Int128Like Mul128x64(in Int128Like a, long b)
        {
            ...
            // hi = a.hi * b  (SIGNED!)
            long hiLow;
            BigMul(absA.hi64, (long)absB, out hiLow);

            ulong lo = loLow;
            long hi = hiLow + (long)loHigh;
        ...
        /// <summary> Produces the low 128 bits of the full 256-bit product </summary> 
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
